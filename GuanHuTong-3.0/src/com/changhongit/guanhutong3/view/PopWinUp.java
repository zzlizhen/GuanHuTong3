...
public class PopWinUp extends PopupWindow {

	protected final View anchor;
	private View mRoot;
	private final static int MIN_INTERVAL = 500;
//	private final int maxHeight = 321;//popwin ���߶�
	...
	public PopWinUp(View anchor) {
		...
		mRoot = mInflater.inflate(R.layout.popup_up, null);

		this.setContentView(mRoot);
		mGroup = (RadioGroup) mRoot.findViewById(R.id.group);
	}
	
	public static PopWinUp getInstance(View anchor){
	...
	protected void preShow(int height) {
		...
		setWidth(anchor.getWidth()+20);  //设置和控件等宽
		if(height > maxHeight){
			setHeight(maxHeight);
		} else {
...
//		xPos = anchorRect.centerX() - rootWidth/2;
		xPos = anchorRect.left-10;

		yPos = yPos>anchorRect.bottom?yPos:anchorRect.bottom;
...
//			if(mItems.get(i).equals(GhtApplication.mCurrentTerminal.getTerminal())){
//				rb.setChecked(true);
//			}
//			else{
//				rb.setChecked(false);	
...
//		radioButton.setTextAppearance(mContext, android.R.style.TextAppearance_Medium);
		radioButton.setTextColor(Color.BLACK);
		radioButton.setGravity(Gravity.CENTER);
//		radioButton.setPadding(40, 15, 40, 15);
		radioButton.setPadding(10, 0, 10, 0);
//		radioButton.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.btn_app_manage_bg));
	...
	public void setyPos(View view) {
		...
		this.yPos = location[1] + view.getHeight() - 8;//��ȥ��ͷ�ĸ߶�
	}
	...
	public void checkedSet(int position){
