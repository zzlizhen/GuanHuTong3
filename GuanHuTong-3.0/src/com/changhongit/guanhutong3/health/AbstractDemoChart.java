...
public abstract class AbstractDemoChart implements IDemoChart {
	...
	protected void setChartSettings(XYMultipleSeriesRenderer renderer,
			...
			int labelsColor) {
		renderer.setAxisTitleTextSize(30); // 坐标轴标题字体大小：16
		renderer.setChartTitleTextSize(30); // 图表标题字体大小：20
		renderer.setLabelsTextSize(15); // 轴标签字体大小：15
		renderer.setLegendTextSize(30); // 图例字体大小：15
		...
		renderer.setMargins(new int[] { 50, 60, 30, 30 });//上，左，下，右
	}
